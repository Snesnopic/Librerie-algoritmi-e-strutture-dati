...
/* ************************************************************************** */
    ...
    public:
        ...
        // Move assignment
        virtual Queue &
        operator=(Queue &&q) noexcept = delete; // Move assignment of abstract types should not be possible.

        /* ************************************************************************ */

        // Comparison operators
        virtual bool
        operator==(const Queue &q) const noexcept = delete; // Comparison of abstract types might not be possible.
        virtual bool
        operator!=(const Queue &q) const noexcept = delete; // Comparison of abstract types might not be possible.
        ...
        virtual const Data &
        Head() const = 0; // (constant version; concrete function must throw std::length_error when empty)
