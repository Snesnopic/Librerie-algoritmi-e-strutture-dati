...
void vectortest(Vector<Data> &v) {
    ...
    while (!selection) {
        cout << "0. Torna indietro" << endl << "1. Stampa tutti gli elementi" << endl
             << "2. Controlla esistenza di un elemento" << endl
        ...
        switch (testtype) {
            ...
            case 3: {
                if constexpr (is_same<Data, int>::value) {
                    cout << "Funzione fold per questo tipo di dato: Somma per gli interi minori di n" << endl
                         << "Inserisci n:   ";
                    long n{};
                    cin >> n;
                    long result = 0;
                ...
                if constexpr (is_same<Data, double>::value) {
                    cout << "Funzione fold per questo tipo di dato: Prodotto per i double maggiori di n;" << endl
                         << "Inserisci n:   ";
                ...
                if constexpr (is_same<Data, string>::value) {
                    cout << "Funzione fold per questo tipo di dato: Concatenazione con lunghezza minore o uguale a n;"
                         << endl << "Inserisci n:   ";
                    unsigned long n{};
                    cin >> n;
                    string result = "";
...
void stacktest(Stack<Data> &s) {
    ...
    int testtype;
    while (!selection) {
        cout << "0. Torna indietro" << endl << "1. Inserisci un elemento" << endl << "2. Rimuovi un elemento" << endl
             << "3. Visualizza e rimuovi un elemento" << endl
             << "4. Visualizza un elemento" << endl << "5. E' vuoto?" << endl << "6. Stampa grandezza" << endl
...
void binarytreetest(BinaryTree<Data> &bt) {
    ...
    while (!selection) {
        cout << "0. Torna indietro" << endl << "1. Visualizza in ampiezza" << endl << "2. Visualizza in pre-ordine"
             << endl << "3. Visualizza in ordine" << endl
             << "4. Visualizza in post-ordine" << endl << "5. Controlla esistenza di un valore" << endl
             << "6. Calcola la funzione fold relativa al dato" << endl
        ...
        switch (testtype) {
            ...
            case 6: {
                if constexpr (is_same<Data, int>::value) {
                    cout << "Funzione fold per questo tipo di dato: Prodotto per gli interi minori di n" << endl
                         << "Inserisci n:   ";
                    int n{};
                    cin >> n;
                    long result = 1;
                ...
                if constexpr (is_same<Data, double>::value) {
                    cout << "Funzione fold per questo tipo di dato: Somma per i double maggiori di n;" << endl
                         << "Inserisci n:   ";
                    double n{};
                    cin >> n;
                    double result = 0;
...
void bsttest(BST<Data> &bst) {
    ...
    while (!selection) {
        cout << "0. Torna indietro" << endl << "1. Visualizza in ampiezza" << endl << "2. Visualizza in pre-ordine"
             ...
             << "4. Visualizza in post-ordine" << endl << "5. Controlla esistenza di un valore" << endl
             << "6. Calcola la funzione fold relativa al dato" << endl
             << "7. Rimuovi un valore" << endl << "8. Stampa la size" << endl;
        string input;
        cin >> input;
        testtype = stoi(input);
        switch (testtype) {
...
void vectortest() {
    ...
    bool selection = false;
    while (!selection) {
        cout << endl << "Che tipo di dato vuoi usare?" << endl << "1. Test su Int" << endl << "2. Test su Double"
             << endl << "3. Test su String" << endl << "0. Torna indietro"
             << endl;
        string input;
        cin >> input;
        testtype = stoi(input);
...
void stacktest() {
    ...
    cin >> input;
    size = stoi(input);
    cout << endl << "Che tipo di dato vuoi usare?" << endl << "1. Test su Int" << endl << "2. Test su Double" << endl
         << "3. Test su String" << endl << "0. Torna indietro" << endl;
    bool selection = false;
    while (!selection) {
        string input;
        cin >> input;
...
void mytest() {
    ...
    while (!selection) {
        cout << endl << "Test menu' " << endl << "0. Esci" << endl << "1. Test su List" << endl << "2. Test su Vector"
             << endl << "3. Test su Stack" << endl << "4. Test su Queue"
