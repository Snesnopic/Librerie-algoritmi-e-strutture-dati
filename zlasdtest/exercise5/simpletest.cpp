...
void stestHashTableInt(lasd::HashTable<int>& ht, const lasd::LinearContainer<int>& con, unsigned int& testnum, unsigned int& testerr)
{
...
void stestHashTableInt(unsigned int& testnum, unsigned int& testerr)
{
	unsigned int loctestnum = 0, loctesterr = 0;
...
void stestHashTableFloat(lasd::HashTable<double>& ht, const lasd::LinearContainer<double>& con, unsigned int& testnum, unsigned int& testerr)
{
	unsigned int loctestnum = 0, loctesterr = 0;
	try
	{
...
void stestHashTableFloat(unsigned int& testnum, unsigned int& testerr)
{
	unsigned int loctestnum = 0, loctesterr = 0;
...
void stestHashTableString(lasd::HashTable<string>& ht, const lasd::LinearContainer<string>& con, unsigned int& testnum, unsigned int& testerr)
{
	unsigned int loctestnum = 0, loctesterr = 0;
	try
	{
...
void stestHashTableString(unsigned int& testnum, unsigned int& testerr)
{
	unsigned int loctestnum = 0, loctesterr = 0;
